...
/mob/living/simple_animal/hostile/megafauna/dragon/visible_message(message,
	self_message,
	blind_message,
	...
	separation = " ",
	pref_to_check,
	list/message_data = list())  // SKYRAT EDIT ADDITION - Better emotes - Original: /mob/living/simple_animal/hostile/megafauna/dragon/visible_message(message, self_message, blind_message, vision_distance = DEFAULT_MESSAGE_RANGE, list/ignored_mobs, visible_message_flags = NONE), pref checks
