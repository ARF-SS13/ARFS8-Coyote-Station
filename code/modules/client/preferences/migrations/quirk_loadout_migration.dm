 ...
 */
/datum/prefs_holder/proc/migrate_quirk_to_loadout(quirk_to_migrate, new_typepath, list/data_to_migrate)
...
/datum/prefs_holder/proc/add_loadout_item(typepath, list/data = list())
	PRIVATE_PROC(TRUE)
...
/datum/prefs_holder/proc/remove_loadout_item(typepath)
	PRIVATE_PROC(TRUE)
