...
/datum/reagent/consumable/ethanol/twinkjuice/on_mob_metabolize(mob/living/affected_mob)
	...
	if (ishuman(affected_mob))
		if(affected_mob.client?.prefs.read_preference(/datum/preference/toggle/erp/aphro))
			affected_mob.log_message("drank [src], but wasn't effected by it.", LOG_EMOTE)
			return
...
// 	. = TRUE
// Bro what the fuck is with these assholes and their gamer juice.  Fuck off.
...
//Donator items
//No, I don't fucking think so, Gamer Juice Man.
