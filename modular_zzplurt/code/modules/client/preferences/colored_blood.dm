...
/datum/preference/toggle/custom_blood_color/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
	return TRUE
...
/datum/preference/color/blood_color/is_accessible(datum/prefs_holder/preferences)
	if (!..(preferences))
		return FALSE
