...
./code/modules/mob/dead/new_player/preferences_setup.dm > /datum/prefs_holder/proc/random_character(), /datum/prefs_holder/proc/random_species(), /datum/prefs_holder/proc/update_preview_icon()
