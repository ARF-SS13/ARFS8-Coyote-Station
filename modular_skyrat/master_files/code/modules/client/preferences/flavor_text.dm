...
/datum/preference/text/flavor_text/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
...
/datum/preference/text/silicon_flavor_text/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
...
/datum/preference/text/ooc_notes/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
...
/datum/preference/text/custom_species/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
	target.dna.features["custom_species"] = value

/datum/preference/text/custom_species/is_accessible(datum/prefs_holder/preferences)
...
/datum/preference/text/taste/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
...
/datum/preference/text/smell/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
...
/datum/preference/text/custom_species_lore/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
	target.dna.features["custom_species_lore"] = value

/datum/preference/text/custom_species_lore/is_accessible(datum/prefs_holder/preferences)
	var/datum/species/species_type = preferences.read_preference(/datum/preference/choiced/species)
	if(species_type)
		if(initial(species_type.lore_protected))
			return FALSE
...
/datum/preference/text/general/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
	return FALSE
...
/datum/preference/text/medical/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
	return FALSE
...
/datum/preference/text/security/apply_to_human(mob/living/carbon/human/target, value, datum/prefs_holder/preferences)
	return FALSE
